...
echo "valores1 : ",$usuario, $_POST['password'],"<br>";
sec_session_start(); // Our custom secure way of starting a PHP session.


if (isset($_POST['usuario'], $_POST['psha'])) {
    $usuario = $_POST['usuario'];
    $password = $_POST['psha']; // The hashed password.
echo "valores: ",$usuario, $password,"<br>";
...
// Este enlace es para borrar el registro y también se explicará más tarde
        ...
        // Login failed
        ?>
<h1>Fallo de login</h1>
        <form action = "index.php?p=login" method = "post" name = "login_form">
